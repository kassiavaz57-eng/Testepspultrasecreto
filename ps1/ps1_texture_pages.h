...
typedef struct Ps1AtlasTileEntry Ps1AtlasTileEntry;
...
uint16_t Ps1TexturePages_resolveAtlasTile(Ps1TexturePages* cache, const Ps1AtlasTileEntry* entry, Ps1TexturePagePiece outPieces[PS1_TEX_MAX_TPAG_PIECES]);
